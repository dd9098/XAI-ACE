...
def main(args):
    ...
    results_summaries_dir = os.path.join(
        args.working_dir, 'results_summaries/')
    
    if not tf.io.gfile.exists(args.working_dir):
...
def parse_arguments(argv):
    ...
    parser.add_argument('--labels_path', type=str,
                        help='Path to model checkpoints.', default='./UTKface_labels.txt')
